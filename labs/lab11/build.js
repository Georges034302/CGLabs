...
function buildAsteroidBelt() {
    ...
    for (var i = 0; i < asteroidCount; i++) {
        ...
        var sx = asteroidSize * (0.5 + Math.random());
...
/* -----------------------------------------------------
   LAB 8: Declare textured Galactus model variable
   - galactus stores the loaded OBJ/MTL textured asset
   ----------------------------------------------------- */
var galactus;

/* -----------------------------------------------------
   LAB 8: Load textured Galactus OBJ/MTL model
   - load materials from MTL file
   - load geometry from OBJ file
   - scale and position the model in the scene
   ----------------------------------------------------- */
...
/* -----------------------------------------------------
   LAB 9: Declare Galactus beam variables
   - beamLeft and beamRight store the two eye beams
   ----------------------------------------------------- */
var beamLeft, beamRight;

/* -----------------------------------------------------
   LAB 9: Create Galactus eye beams
   - create two red beams that start hidden
   - beams will be activated during animation
   ----------------------------------------------------- */
...
/* -----------------------------------------------------
   LAB 10: Declare shader solar-emission variables
   ----------------------------------------------------- */
var cloud;
var cloudBaseRadius = 4.5;
var cloudScale = 1.0;

/* -----------------------------------------------------
   LAB 10: Build shader-based solar emission cloud
   - create a point sphere around the Sun
   - assign one alpha value per vertex
   - use custom shaders for colour + transparency
   ----------------------------------------------------- */
